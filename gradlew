...
<project version="4">
  ...
  <component name="AvailableLibraryUpdateStorage">
    <library-updates>
      ...
      <library-update>
        <group-id>androidx.core</group-id>
        <name>core-ktx</name>
      ...
      <library-update>
        <group-id>com.facebook.android</group-id>
        <name>facebook-core</name>
        <version>6.3.0</version>
        <repository>JCenter</repository>
      </library-update>
      <library-update>
        <group-id>androidx.navigation</group-id>
        <name>navigation-fragment-ktx</name>
      ...
      <library-update>
        <group-id>com.github.bumptech.glide</group-id>
        <name>glide</name>
        <version>4.11.0</version>
        <repository>JCenter</repository>
      </library-update>
      <library-update>
        <group-id>com.google.maps.android</group-id>
        <name>android-maps-utils</name>
        <version>1.0.2</version>
        <repository>JCenter</repository>
      </library-update>
      <library-update>
        <group-id>androidx.constraintlayout</group-id>
      ...
      <library-update>
        <group-id>com.google.android.gms</group-id>
        <name>play-services-auth</name>
        <version>17.0.0</version>
        <repository>Google,Google Repository</repository>
      </library-update>
      <library-update>
        <group-id>com.google.android.gms</group-id>
        <name>play-services-places</name>
        <version>17.0.0</version>
        <repository>Google,Google Repository</repository>
      </library-update>
      <library-update>
    ...
    <last-search-timestamp>1585699499040</last-search-ti